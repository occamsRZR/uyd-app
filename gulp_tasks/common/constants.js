...
module.exports = function() {
    ...
    var constants = {
        ...
        repository: 'https://github.com/occamsRZR/uyd-app',
        ...
        fonts: {
            src: ['./' + clientFolder + '/fonts/*.*', './' + clientFolder + '/fonts/{{targetName}}/**/*.*', './bower_components/ionic/release/fonts/*.*', './bower_components/font-awesome/fonts/*.*', './bower_components/bootstrap/dist/fonts/*.*'], // you can also add a specific src_appname
            dest: 'fonts'
        },
        html: {
        ...
        serve: {
            ...
            localtunnel: false // true, false or 'uydapp'
        },
        mocha: {
            libs: ['server/**/*.js'],
            tests: ['test/mocha/**/*.js'],
